...
def training():
    ...
    for number in range(10):
        ...
        model = hmm.PoissonHMM(n_components=5, init_params='st', covariance_type="full", n_iter = 100)
        ...
        for i in range(4):
            ...
            modelgreedy = hmm.PoissonHMM(n_components=5, init_params='st', covariance_type="full", n_iter = 100)
