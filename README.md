...
O dataset utilizado foi o AudioMNIST, disponível [neste link](https://github.com/soerenab/AudioMNIST). Ele contém os aúdios de 60 falantes repetindo os números de 0 a 9 um total de 50 vezes para cada número, para um total de 30.000 aúdios. A frequência de amostragem dos aúdios é de 48kHz.
